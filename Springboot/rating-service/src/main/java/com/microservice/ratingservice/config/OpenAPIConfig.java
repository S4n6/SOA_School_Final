...
public class OpenAPIConfig {
    ...
    public OpenAPI myOpenAPI() {
        Server ratingServer = new Server();
        String ratingURL = "localhost:8087";
        ratingServer.setUrl(ratingURL);
        ratingServer.setDescription("rating Service");
        ...
        return new OpenAPI().info(info).servers(List.of(ratingServer));
    }
}