...
public class OpenAPIConfig {
    ...
    public OpenAPI myOpenAPI() {
        Server paymentServer = new Server();
        String paymentURL = "localhost:8086";
        paymentServer.setUrl(paymentURL);
        paymentServer.setDescription("payment Service");
        ...
        return new OpenAPI().info(info).servers(List.of(paymentServer));
    }
}