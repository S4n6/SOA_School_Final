package com.microservice.film_service.film_service.config;
...
public class OpenAPIConfig {
    ...
    public OpenAPI myOpenAPI() {
        Server filmServer = new Server();
        String filmURL = "localhost:8081";
        filmServer.setUrl(filmURL);
        filmServer.setDescription("Film Service");
        ...
        return new OpenAPI().info(info).servers(List.of(filmServer));
    }
}